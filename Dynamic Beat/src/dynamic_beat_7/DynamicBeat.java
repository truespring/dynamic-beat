...
public class DynamicBeat extends JFrame {
	...
	public DynamicBeat() {
		...
		trackList.add(new Track("Faded Title Image.png", "Faded Start Image.png", "Faded Game Image.png",
		...
		trackList.add(new Track("The Spectre Title Image.png", "The Spectre Start Image.png",
				"The Spectre Game Image.png", "Alan Walker - The Spectre HL.mp3", "Alan Walker - The Spectre.mp3"));
